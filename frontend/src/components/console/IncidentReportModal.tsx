...
export const IncidentReportModal: React.FC<IncidentReportModalProps> = ({
  ...
  const { submitIncident, demoVaultAddress } = useProtocol();
  ...
  const handleFillDemoExploit = () => {
    setDescription("Critical reentrancy drain exploit observed with recursive withdrawal call.");
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 text-xs font-mono">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Describe the anomalous pattern, drain rate, reentrancy trace, or exploit signature..."
              required
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-white/10">
            ...
            >
              ...
              <span>{isSubmitting ? "Broadcasting..." : "Broadcast Incident"}</span>
            </button>
          </div>
        </form>
      </div>
